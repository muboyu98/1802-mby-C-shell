...
void writeTemp() {        // 调用shell脚本，从shell脚本输入，shell会创建txt文件 
	printf("姓名:");
		writeTempFile("name.sh");
    printf("学号:");
    	writeTempFile("num.sh");
    printf("性别:");
    	writeTempFile("sex.sh");
    printf("籍贯:");
    	writeTempFile("from.sh");
    printf("政治面貌:");
        writeTempFile("political.sh");
    printf("手机号:");
    	writeTempFile("phone.sh");
    printf("QQ号:");
    	writeTempFile("QQ.sh");
    printf("宿舍:");
    	writeTempFile("dorm.sh");
}
